                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                ElevatedButton(
                                  onPressed: () async {
                                    log('🔹 Subscription button clicked');
                                    log('📋 Plan ID: ${plan.id}');
                                    log('🏪 Shop ID: ${widget.shopId}');

                                    if (widget.shopId == null ||
                                        plan.id == null) {
                                      log(
                                        '❌ Error: Shop ID or Plan ID is null',
                                      );
                                      ScaffoldMessenger.of(
                                        ...
                                        const SnackBar(
                                          content: Text(
                                            "Error: Missing Shop ID or Plan ID",
                                          ),
                                    ...
                                    // Start subscription and get order ID
                                    ...
                                    if (startProvider.errorMessage != null ||
                                        result == null) {
                                      log(
                                        '❌ Subscription failed: ${startProvider.errorMessage}',
                                      );
                                      ScaffoldMessenger.of(
                                        // ignore: use_build_context_synchronously
                                        context,
                                    ...
                                    log(
                                      '✅ Subscription started successfully, order ID: ${result.orderId}',
                                    );

                                    // 🔹 Log data being passed to PaymentScreen
                                    log('➡️ Passing to PaymentScreen:');
                                    log('   Name: ${plan.name}');
                                    log('   Duration: ${plan.durationType}');
                                    log('   Amount: ${plan.totalAmount}');
