...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  Future<void> _submitProduct(BuildContext context) async {
    ...
    // Validate required fields (image is NOT required)
    ...
    await provider.createProduct(
      ...
      productImage: _selectedImage, // Optional - can be null
      price: price,
                ...
                child: Column(
                  children: [
                    Padding(
                      ...
                      child: Column(
                        children: [
                          _buildSubscriptionErrorSection(productProvider),
                        ],
                      ),
                    ),
                    Form(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            // Image picker (optional) - No validation, no requirement
                            _buildImagePicker(),
  ...
  Widget _buildImagePicker() {
    return Column(
      ...
      children: [
        ...
        // const Text(
        //   "You can add an image later if you don't have one now",
