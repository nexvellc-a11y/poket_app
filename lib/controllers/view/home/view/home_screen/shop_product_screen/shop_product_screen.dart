          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                if (widget.shop.mobileNumber?.isNotEmpty == true &&
                    widget.shop.locality?.isNotEmpty == true)
                  const SizedBox(height: 2),

                // Location
                if (widget.shop.locality?.isNotEmpty == true)
                  Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Icon(
                      ...
                      children: [
                        Text(
                          ...
                          style: textTheme.bodyMedium?.copyWith(
                            fontWeight: FontWeight.w600,
                            fontSize:
                                _isMobile ? 13 : 15, // Slightly smaller font
                        ...
                        Text(
                          product.itemType ?? 'Unknown type',

                          style: TextStyle(
                            fontWeight: FontWeight.w600,
                            fontSize:
                                _isMobile ? 12 : 14, // Slightly smaller font
                            height: 1.2,
                            color: Colors.blue,
                          ),
